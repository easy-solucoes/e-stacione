export const parkingSpaces = [
     ...
     new CreateNewParkingSpace('Jardim das Palmeiras', 'Casa', -22.241319453116596, -45.71393399700916),
     new CreateNewParkingSpace('Jardim das Palmeiras', 'JFL', -22.241557494599803, -45.71564908928338)
]
